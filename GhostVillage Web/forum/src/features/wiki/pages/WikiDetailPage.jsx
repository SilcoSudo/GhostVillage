  ...
  if (!wiki) {
    return (
      <div className="error-page">
        <h2>Không tìm thấy wiki</h2>
        <Link to="/wiki">← Quay lại Wiki</Link>
      </div>
    );
  }
      ...
      <div className="wiki-header">
        ...
        <div className="wiki-meta">
          <div className="meta-item">
            <User size={16} />
            <span>{wiki.author?.fullname || 'Anonymous'}</span>
          </div>
          <div className="meta-item">
            <Calendar size={16} />
            <span>{new Date(wiki.createdAt).toLocaleDateString('vi-VN')}</span>
          </div>
          <div className="meta-item">
            <Eye size={16} />
            <span>{wiki.views} lượt xem</span>
          </div>
          <div className="meta-item">
            <ThumbsUp size={16} />
            <span>{wiki.likes} thích</span>
          </div>
        </div>
