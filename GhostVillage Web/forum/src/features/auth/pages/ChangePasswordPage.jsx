...
const ChangePasswordPage = () => {
  ...
  const validateForm = () => {
    if (!formData.currentPassword) {
      setMessage({
        type: "error",
        text: t("changePassword.validation.currentRequired"),
      });
      return false;
    }
    ...
    if (!formData.newPassword) {
      setMessage({
        type: "error",
        text: t("changePassword.validation.newRequired"),
      });
      return false;
    }
    ...
    if (formData.newPassword !== formData.confirmPassword) {
      setMessage({
        type: "error",
        text: t("changePassword.validation.passwordsMatch"),
      });
      return false;
    }
    ...
    if (formData.currentPassword === formData.newPassword) {
      setMessage({
        type: "error",
        text: t("changePassword.validation.differentPassword"),
      });
      return false;
    }
    ...
    if (!passwordStrength.isStrong) {
      setMessage({
        type: "error",
        text: t("changePassword.validation.weakPassword"),
      });
      return false;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage =
        error.response?.data?.message || t("changePassword.messages.failed");
            ...
            <Card.Body className="p-4">
              ...
              <Form onSubmit={handleSubmit}>
                  ...
                  {formData.newPassword && (
                    <div className="mt-2">
                      <div className="d-flex align-items-center gap-2 mb-2">
                        ...
                        <span
                          className={`badge bg-${getPasswordStrengthColor(passwordStrength.score)}`}
                        >
                      ...
                      <div className="small">
                        {passwordStrength.criteria?.map((criterion, index) => (
                          <div
                            key={index}
                            className={`d-flex align-items-center gap-1 ${criterion.met ? "text-success" : "text-muted"}`}
                          >
                            {criterion.met ? (
                              <Check size={12} />
                            ) : (
                ...
                <Alert variant="info" className="mb-4">
                  ...
                  <small>{t("changePassword.securityInfo")}</small>
                </Alert>
