...
import { X, Loader2, Plus, Trash2, Target, Award } from "lucide-react";
import questService from "../../shared/services/questService";
import "../assets/styles/Modal.css";

/**
 * Create Quest Modal Component
 * Modal để tạo quest mới với objectives và rewards
 */
const CreateQuestModal = ({ onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || "Lỗi khi tạo quest");
    } finally {
      setLoading(false);
    }
  };
