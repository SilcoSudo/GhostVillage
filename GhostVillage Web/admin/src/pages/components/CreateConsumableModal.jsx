...
/**
 * Create Consumable Item Modal Component
 * Modal để tạo consumable item mới với effects
 */
const CreateConsumableModal = ({ onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await consumableService.createConsumable(formData);
      ...
      setError(err.response?.data?.message || "Lỗi khi tạo consumable item");
    } finally {
      setLoading(false);
    }
  };
