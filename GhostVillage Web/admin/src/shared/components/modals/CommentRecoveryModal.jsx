...
const CommentRecoveryModal = ({
  ...
  return (
    <div
      className="modal-overlay comment-recovery-overlay"
      onClick={handleClose}
    >
      <div
        className="modal-content comment-recovery-modal"
        ...
        <div className="modal-body">
          ...
          <div className="recovery-alert">
            ...
            <div className="alert-content">
              <p className="alert-title">
                {t("comments.restoreWarning") ||
                  "Are you sure you want to restore this comment?"}
              </p>
              <p className="alert-description">
                {t("comments.restoreWarningDesc") ||
                  "The comment will be made visible to users again. This action can be undone."}
              </p>
            </div>
          </div>
          ...
          <div className="recovery-comment-info">
            <div className="info-item">
              ...
              <span className="info-value comment-preview">
                {comment.commentText}
              </span>
            </div>
            <div className="info-item">
          ...
          <div className="recovery-notes">
            ...
            <textarea
              ...
              placeholder={
                t("comments.recoveryNotesPlaceholder") ||
                "Enter notes about why this comment is being restored..."
              }
